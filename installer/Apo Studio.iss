...
#define MyAppVersion "1.0.4.1.0"
#define MyAppPublisher "APO Studio"
#define MyAppExeName "APO Studio.exe"

[Setup]
AppId={{A9E2E2D4-5F74-4A9F-9E63-APOSTUDIO001}}
AppName={#MyAppName}
...
UninstallDisplayName=APO Studio
...
[Files]
Source: "..\dist\APO Studio\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
